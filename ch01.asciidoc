...
Als ontwikkelaar zie ik bitcoin verwant aan _the internet of money_, een netwerk voor het verspreiden van waarde en het beveiligen van eigendom van digitale activa via een gedistribueerde oplossing. Bitcoin omvat veel meer dan wat zichtbaar is bij een eerste indruk.
